...
export default function ShuffleSection({
  ...
  return (
    <section id="shuffle-deck" className="relative pt-3.5 pb-8 sm:py-16 md:py-20 bg-[#070709] border-t border-white/[0.06] overflow-hidden scroll-mt-28 sm:scroll-mt-32 md:scroll-mt-36">
