        ...
        <div className="flex items-center gap-3 sm:gap-4 min-w-0">
          ...
          <div className="flex flex-col gap-1 min-w-0">
            ...
            <div className="flex items-center gap-2 text-[10px] sm:text-xs text-zinc-400">
              <span className="px-1.5 py-0.5 rounded bg-zinc-800/80 text-[9px] sm:text-[10px] font-semibold tracking-wider text-zinc-300 uppercase">
                {article.category}
              </span>
              <span>•</span>
    ...
    >
      ...
      <div className="p-3.5 sm:p-4 xl:p-4.5 flex flex-col flex-1">
        ...
        <div className="flex items-center justify-between gap-2 mb-2">
          <span className="text-[9px] sm:text-[10px] font-bold tracking-wider text-zinc-400 uppercase">
            {article.category}
          </span>
