...
const DYNAMIC_ARTICLES_KEY = 'readainews_dynamic_articles_v25';
const POOL_STORAGE_KEY = 'readainews_fresh_pool_v25';
const REFRESH_TIMESTAMP_KEY = 'readainews_fresh_timestamp_v25';

// Clean up any legacy caches containing slow, stale or previous version data
if (typeof window !== 'undefined' && typeof localStorage !== 'undefined') {
  try {
    ['v20', 'v21', 'v22', 'v23', 'v24'].forEach(v => {
      ...
      if (typeof window !== 'undefined') {
        ...
        for (let i = 0; i < localStorage.length; i++) {
          ...
          if (key && (
            ...
            (key.startsWith('readainews_') && !key.includes('_v21') && !key.includes('readainews_saved_ids'))
          )) {
