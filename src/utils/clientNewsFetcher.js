...
export const STORAGE_KEY_POOL = 'readainews_fresh_pool_v22';
export const STORAGE_KEY_TIMESTAMP = 'readainews_fresh_timestamp_v22';
export const STORAGE_KEY_HOUR = 'readainews_fresh_hour_v22';
