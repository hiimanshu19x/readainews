...
export const STORAGE_KEY_POOL = 'readainews_fresh_pool_v24';
export const STORAGE_KEY_TIMESTAMP = 'readainews_fresh_timestamp_v24';
export const STORAGE_KEY_HOUR = 'readainews_fresh_hour_v24';
